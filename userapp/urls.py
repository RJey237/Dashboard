...
from .views import login_view,logout_view,group_list,group_detail,student_info,admin_panel,user_list,user_create,user_update,user_delete,toggle_user_active,profile,password_reset_request
urlpatterns = [
