...
(function($) {
	...
	jQuery('#theme_direction').on('change',function(){
		...
		if(html.attr('dir') === "rtl"){
            jQuery('.main-css').attr('href','/static/css/style-rtl.css');
		}else{
            jQuery('.main-css').attr('href','/static/css/style.css')
		}
